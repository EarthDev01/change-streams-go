...
const _routes = [
  {
    ...
    component: () => import('./index-CQVjGB9T.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./login-D8i8_shz.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./register-CgdOiOHG.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": ["auth"] },
    component: () => import('./dashboard-CPb_t4Wy.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-vhMjxT-K.mjs')
  },
  {
    name: "admin-register",
    path: "/admin/register",
    meta: __nuxt_page_meta || {},
    component: () => import('./register-DI_K_bBj.mjs')
  },
  {
    name: "admin-dashboard",
    path: "/admin/dashboard",
    meta: { "middleware": ["admin"] },
    component: () => import('./dashboard-BHxbHptN.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-CfDzNrlc.mjs'),
  auth: () => import('./auth-KiFR6SRV.mjs')
};
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-DHMryigU.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BDXY6pN_.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Ut5iGa1m.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CdNanPCA.mjs'));
...
export { _export_sfc as _, useRoute as a, useNuxtApp as b, useRuntimeConfig as c, defineNuxtRouteMiddleware as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
