...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-slate-900 border border-slate-800 rounded-2xl p-8" }, _attrs))}><h2 class="text-xl font-bold text-white mb-1">Create account</h2><p class="text-slate-400 text-sm mb-6">Get started with ChangeStreams</p>`);
      if (unref(error)) {
      ...
      _push(`</button></form><p class="text-slate-400 text-sm text-center mt-6"> Already have an account? `);
...
//# sourceMappingURL=register-CgdOiOHG.mjs.map
