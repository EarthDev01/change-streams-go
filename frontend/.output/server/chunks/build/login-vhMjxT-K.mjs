...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-slate-900 border border-slate-800 rounded-2xl p-8" }, _attrs))}><div class="flex items-center gap-2 mb-1"><span class="text-xs bg-primary-600/20 text-primary-400 border border-primary-500/30 px-2 py-0.5 rounded-full font-medium"> Admin </span><h2 class="text-xl font-bold text-white">Sign in</h2></div><p class="text-slate-400 text-sm mb-6">Access the admin panel</p>`);
      if (unref(error)) {
      ...
      if (unref(loading)) {
        ...
        _push(`<span>Sign in as admin</span>`);
      }
      _push(`</button></form><p class="text-slate-400 text-sm text-center mt-6"> New admin? `);
      ...
      _push(`</p><p class="text-slate-500 text-xs text-center mt-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/login",
...
//# sourceMappingURL=login-vhMjxT-K.mjs.map
