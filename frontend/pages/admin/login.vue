...
<template>
  <div class="bg-slate-900 border border-slate-800 rounded-2xl p-8">
    ...
    <p class="text-slate-400 text-sm mb-6">Access the admin panel</p>
    ...
    <p class="text-slate-400 text-sm text-center mt-6">
      New admin?
      <NuxtLink to="/admin/register" class="text-primary-400 hover:text-primary-300 font-medium transition-colors">
        Register here
      </NuxtLink>
    </p>
    <p class="text-slate-500 text-xs text-center mt-2">
      <NuxtLink to="/login" class="text-slate-400 hover:text-slate-300 transition-colors">
        ← Back to user login
      </NuxtLink>
    </p>
  </div>
